...
class OnnxStableDiffusionLongPromptWeightingPipeline(OnnxStableDiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        extra_step_kwargs = self.prepare_extra_step_kwargs(ancestral_generator, eta)
        ...
        for i, t in enumerate(self.progress_bar(timesteps)):
            ...
            if i % callback_steps == 0:
                if callback is not None:
                    callback(i, t, latents, timesteps)
                if is_cancelled_callback is not None and is_cancelled_callback():
                    return StableDiffusionPipelineOutput(images=None, nsfw_content_detected=None)
    ...
    def inpaint_new(
        ...
        **kwargs,
        ...
        latents = latents.numpy().astype(latents_dtype)
